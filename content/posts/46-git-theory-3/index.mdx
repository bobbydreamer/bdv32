...
date: 2020-10-05
description: This part of Git series covers revert, reset and restore
tags:
  - notes
  - git
...
```
![git checkout setup](./git-checkout1.png)  
...
![git checkout -- fileA.txt](./git-checkout2.png)
...
![git checkout HEAD -- fileA.txt](./git-checkout3.png)
...
![git reset --soft](./git-reset-soft-1.png)
...
![git reset --soft](./git-reset-soft-2.png)
...
![git reset --hard](./git-reset-hard-1.png)
...
![git reset --hard](./git-reset-hard-2.png)
...
![git revert HEAD~1](./git-revert-1.png)
...
abc                                                                        |
def                                                                        |
>>>>>>> parent of efada58... Added ghi, CAPS in abc.txt and 123 to 123.txt |
```
