...
![git branching](./git24.png)  

##### Detached HEAD     

![git branching](./git25.png)  
...
![git merge graph](./git30.png)

Make a note of the strategy in the above diagram **recursive**

##### Lets rewind a bit and do fast-forward merge
![Remove a commit](./git31.png)

![git reset -hard](./git32.png)

![Fast-forward strategy](./git33.png)
This is a fast-forward merge 

![Fast-forward strategy](./git34.png)
...
![git rebase practical](./git37.png)
