...
![Reducing product lifecycle fiction](./sre3.png)  
...
![Class SRE implements Devops](./sre4.png)  

**Error Budgets : Key principles of SRE**
* How to measure reliability

![Availability](./sre5.png)  

![Allowed Availability Window](./sre6.png)  
...
![Developers Vs. Operators](./sre7.png)  
...
![Availability disruption due to other factors](./sre8.png)  
...
**SRE Practices**    
  ...
  * Capping and Eliminating toil
    ...
    a. Your service is not successful, you business goes under and none of this matters
    b. Your service is successful and toil typically grows roughly linearly with the size of your business. If your team is 50% occupied with toil and not doing anything to fix it and your business doubles, you will need more SREs, not a good plan. 
...
![Counters, Gauges and Distribution](./sre16.png)  
...
![Incidents trend](./sre18.png)  

![Incidents trend](./sre19.png)  
