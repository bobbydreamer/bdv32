...
| Forcibly delete the branch                                   | `git branch –D feature`         |
...
| Download objects and refs from remote repository                        | `git fetch --all`      |
| Fetch and merge changes on the remote server to your working directory: | `git pull`             |
| List all currently configured remote repository urls             | `git remote -v`               |
| Pushing commits to remote                                        | `git push`                    |
| Push and add upstream(tracking) reference for argument-less pull | `git push -u <remote-branch>` |
