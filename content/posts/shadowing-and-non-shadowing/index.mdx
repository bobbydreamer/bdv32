---
title: GatsbyJS - Shadowing and Non-shadowing
date: 2021-07-16
...
* **src\@lekoarts\gatsby-theme-minimal-blog** : Copy folders `components, hooks, styles, texts` and `utils` from `gatsby-starter-minimal-blog\node_modules\@lekoarts\gatsby-theme-minimal-blog\src`
* **src\pages** : Contains two files seo.js and 404.js
