...
* **[Branching](../47-git-theory-4)** : checkout, merge, rebase, conflicts
* **[Internals](../48-git-theory-5)** : Architecture
* **[Others](../49-git-theory-6)** : .gitignore, stash, clean
...
#### # Concepts & Terminologies
  ...
  - Git is a **Distributed Version Control** and this is how it look like.
    ![Distributed Version Control](./git2.png)  
