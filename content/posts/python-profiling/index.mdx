...
![cProfilev - Main screen ](./cprofilev1.PNG)  
![cProfilev - Function ](./cprofilev2.PNG)  
...
1. Open Cloud Shell and i ran the below commands to set the environment, 
    ...
    ![GCP - Project ID](./GCP-project-id.PNG)  
...
1. Cloud shell also has a Quota, watch out for it. 
    ![Cloud Shell - Quota](./cloud-shell-quota.PNG)
...
[Details are in here](../bse-weekly-trend-analysis-using-pandas-and-numpy)
```
...
### # Related articles
1. [BSE Weekly trend analysis using Pandas & Numpy](../bse-weekly-trend-analysis-using-pandas-and-numpy)
