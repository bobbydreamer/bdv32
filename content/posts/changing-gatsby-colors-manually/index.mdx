...
This uses 
```sh
# Below fontWeight was newly added in the root as the header link were by default 400, 
# which was very thin for this color.
  styles: {
    root: {
      fontWeight: 500,      
    }
...
# Body background and posted link color, it was very hard to find constrasting color for this background 
# has to settle with this primary color. 
    modes: {
      light:{
