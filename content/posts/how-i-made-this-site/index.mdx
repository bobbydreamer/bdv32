...
After seeing the site working. First change we will be making is in `gatsby-config.js` and i have highlighted the updated lines
  ```json:title=gatsby-config.js {7-12,19-38,41-48,57,62,70-72}
...
### # Next steps 
1. [First set of custom changes made to this starter theme](../shadowing-and-non-shadowing)
1. [Adding a Favicon](../adding-favicon-to-gatsby)
