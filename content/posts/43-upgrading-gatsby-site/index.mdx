...
* Font size in code block in the previous version it was bit smaller, now its bigger. Below are the differences found related to the size, decided to leave it as it is. 
  ```ts:title=bdv32\src\@lekoarts\gatsby-theme-minimal-blog\styles\code.ts(diff) {3}
  ".prism-code": {
  -  fontSize: 1,
  -  padding: 3,
  +  fontSize: [1, 1, 2],
...
D:\BigData\08. HTML\Gatsby\lupin\bdv2\src\@lekoarts\gatsby-theme-minimal-blog\texts

https://github.com/bobbydreamer/bdv3.git

git remote add origin https://github.com/bobbydreamer/bdv3.git
git pull https://github.com/bobbydreamer/bdv3.git master


datemodified:3/1/2020..5/1/2020

### # References
* [Previous version : Changing theme of the website manually](./changing-gatsby-colors-manually)
* [Previous version : Making some custom changes to gatsby starter theme](./custom-changes-to-gatsby-theme)